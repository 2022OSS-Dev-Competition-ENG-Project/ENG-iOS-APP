...
class ContentDetailViewModel: ObservableObject {
    ...
    @Published var content: ContentDetailModel = ContentDetailModel(contentNum: 0, contentTitle: "", contentText: "", contentDate: "", contentLook: "", writerUuid: "", writerNickname: "", userLikeBool: 0)
    ...
    func getContent(userUUID: String, contentId: Int) {
        ...
        URLSession.shared.dataTaskPublisher(for: url)
            ...
            .replaceError(with: ContentDetailModel(contentNum: 1, contentTitle: "", contentText: "", contentDate: "", contentLook: "", writerUuid: "", writerNickname: "", userLikeBool: 0))
            .sink { completion in
                print(completion)
